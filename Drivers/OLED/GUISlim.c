...
void GUI_InvertRect(int x0, int y0, int x1, int y1) {
  GUI_LOCK();
  SSD1306_Invert(x0,y0,x1,y1);
  GUI_UNLOCK();
}

void GUI_Write_float2(float num, char x, char y)
{
		int num_int = (int)(num*10);
		int num1 = num_int/100;
		int num2 = num_int%100/10;
		int num3 = num_int%10;
		const char str1 = num1+'0';
		const char str2 = num2+'0';
		const char str3 = num3+'0';
		GUI_DispStringAt(&str1,x,y);
		GUI_DispStringAt(&str2,x+6,y);
		GUI_DispStringAt(".",x+12,y);
		GUI_DispStringAt(&str3,x+15,y);
}

void GUI_Write_float3(float num, char x, char y)
{
		int flag = 0;
		if(num < 0)
		{
		...
		int num_int = (int)(num*10);
		int num1 = num_int/1000;
		int num2 = num_int%1000/100;
		int num3 = num_int%100/10;
		int num4 = num_int%10;
		const char str1 = num1+'0';
		const char str2 = num2+'0';
		const char str3 = num3+'0';
		const char str4 = num4+'0';
		if(flag == 1)
			GUI_DispStringAt("-",x,y);
		if(num1 != 0)
			GUI_DispStringAt(&str1,x+6,y);
		GUI_DispStringAt(&str2,x+12,y);
		GUI_DispStringAt(&str3,x+18,y);
		GUI_DispStringAt(".",x+24,y);
		GUI_DispStringAt(&str4,x+27,y);
}
void GUI_Write_float1(float num, char x, char y)
{
		int num_int = (int)(num*10);
		int num1 = num_int/10;
		int num2 = num_int%10;
		...
		const char str2 = num2+'0';
		GUI_DispStringAt(&str1,x,y);
		GUI_DispStringAt(".",x+6,y);
		GUI_DispStringAt(&str2,x+9,y);
}

void GUI_Write_Num2(int num, char x, char y)
{
		int num1 =  num/10;
		int num2 =  num % 10;
		const char str1 = num1+'0';
...
void GUI_Write_Num4(int num, char x, char y)
{
		int num1 =  num/1000;
		...
		GUI_DispStringAt(&str1,x,y);
		GUI_DispStringAt(&str2,x+6,y);
		GUI_DispStringAt(&str3,x+12,y);
		GUI_DispStringAt(&str4,x+18,y);
}
void GUI_Write_Num5(int num, char x, char y)
{
		int flag = 0;
		if(num < 0) 
		{
		...
		const char str3 = num3+'0';
		const char str4 = num4+'0';
		const char str5 = num5+'0';
		if(flag == 1)
		{
			GUI_DispStringAt("-",x,y);
		}
		GUI_DispStringAt(&str1,x+6,y);
		GUI_DispStringAt(&str2,x+6+6,y);
		GUI_DispStringAt(&str3,x+12+6,y);
		GUI_DispStringAt(&str4,x+18+6,y);
		GUI_DispStringAt(&str5,x+24+6,y);
}
void GUI_Clear(void) {
...
void GUI_DispStringLenAt(const char GUI_UNI_PTR *s, int MaxNumChars, int x, int y) {
  U16 Char;
  GUI_LOCK();
	GUI_Context.DispPosX = x;
  GUI_Context.DispPosY = y;
